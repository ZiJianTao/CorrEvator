...
def graph_prop_once(
  ...
  """
   ...
   # print('tf.shape(node_states)`: ', tf.shape(node_states))
   # print('tf.shape(from_idx)`: ', tf.shape(from_idx))
   # print('tf.shape(to_idx)`: ', tf.shape(to_idx))
    ...
    #print("Edge input shape:", edge_inputs.shape)
   # print("message shape:", messages.shape)
...
class GraphPropMatchingLayer(GraphPropLayer):
  ...
  """
    ...
    """
        ...
        #print("Min from_idx:", tf.reduce_min(from_idx))
        #print("Max from_idx:", tf.reduce_max(from_idx))
        #print("Min to_idx:", tf.reduce_min(to_idx))
        #print("Max to_idx:", tf.reduce_max(to_idx))
        #node_features_length_np = node_features.numpy()
        #print("Node Features Length (NumPy):", node_features_length_np)
